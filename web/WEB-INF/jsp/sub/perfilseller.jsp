...
<html>
    ...
    <body>
        <hr><font color='#1E8449' style="font-family:Century;"> <CENTER><font size="6"><b>VENDEDOR</b></CENTER><hr></font>
                <table align="center">
                    <tr>
                        <td> <center><img src="../img/usuario.png" width="160" height="160"></center></td>
                        <td>
                            <button class="boton1" name="bot2" type="submit" style="margin:0px auto;" onclick="myFunctionC()">
                                CONFIGURACION
                            </button><hr>
